resource "aws_subnet" "public_subnets" {
  ...
  tags = {
    Name                                           = "cops-${var.layer_name}-public-${data.aws_availability_zones.current.zone_ids[count.index]}"
...
resource "aws_route_table" "public_route_table" {
  ...
  vpc_id = local.vpc_id
  tags = {
    Name      = "cops-${var.layer_name}-public"
    terraform = "true"
  }
}
...
resource "aws_internet_gateway" "igw" {
  ...
  tags = {
    Name      = "cops-${var.layer_name}-internet-gateway"
    terraform = "true"
  }
}
